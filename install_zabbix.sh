...
## Configuração do php-fpm.d/zabbix.conf
...
sed -i "s/group = apache/user = nginx/" /etc/php-fpm.d/zabbix.conf

## Configuração do php-fpm.d/www.conf
sed -i "s/# listen.acl_users = apache,nginx/listen.acl_users = nginx/" /etc/php-fpm.d/www.conf
sed -i "s/user = apache/user = nginx/" /etc/php-fpm.d/www.conf
sed -i "s/group = apache/user = nginx/" /etc/php-fpm.d/www.conf
